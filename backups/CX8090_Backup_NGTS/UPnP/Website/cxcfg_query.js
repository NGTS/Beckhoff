...
function query_sr(srData)
{
    ...
    try
    {
        if (srData.loop)
        {
            ...
            lreq_timeout_handle = setTimeout(lreqTimeout, lreq_timeout);
            lreq.send(srData.sr);
        }
        else
        {
            ...
            req_timeout_handle = setTimeout(reqTimeout, req_timeout);
            req.send(srData.sr);
        }
    ...
    {
        clear_info();
        show_info((e.description != null ? e.description : e),"red");
        errors++;
