...
var MODULETYPE_CX9FLASH = 0x001A;
var MODULETYPE_FAN = 0x001B;
var MODULETYPE_MAINBOARD = 0x001C;
var MODULETYPE_DISKMANAGEMENT = 0x001D;
var MODULETYPE_UPS = 0x001E;
...
var lreq;
var req;
var lreq_timeout = 10000;
var req_timeout = 10000;
var lreq_timeout_handle;
var req_timeout_handle;
var lreq_timedout = false;
var req_timedout = false;
var retries = 10;
var tries = 0;
var bidx = 0;
var errors = 0;
...
function WriteTrigger ( name, desc, index, subindex, type, len, value, id ){
    this.name = name;
    this.desc = desc;
    this.index = index;
    this.subindex = subindex;
...
function FunctionLink(funcIndex, funcVarIndex, funcVarName, targetIndex, targetSubIndex) {
    this.funcIndex = funcIndex;
    this.funcVarIndex = funcVarIndex;
    this.funcVarName = funcVarName;
